...
short_description: Retrieve all instances of type vlan. 

description:
  - Queries the UCSPE to retrieve all instances of the vlan type.Returns a dictionary containing each vlan instance object as value .The value is again a dictionary that contains the current configuration.
E.g
