...
DOCUMENTATION = '''
---
module: uuidPoolInstances
short_description: Retrieves all instances of type uuid pool.

description:
  - Queries the UCSPE to retrieve all instances of the uuid pool type.Returns a dictionary containing each uuid_pool pool instance object as value .The value is again a dictionary that contains the current configuration.
E.g
...
def main(): 
	...
	results = query_uuid_poolInstances(json_input)
